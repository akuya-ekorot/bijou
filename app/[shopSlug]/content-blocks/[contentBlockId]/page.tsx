...
import { getPages } from "@/lib/api/pages/queries";import OptimisticContentBlock from "./OptimisticContentBlock";
...
const ContentBlock = async ({ id }: { id: string }) => {
  ...
  const { contentBlock, contentBlockProducts, contentBlockCollections } = await getContentBlockByIdWithContentBlockProductsAndContentBlockCollections(id);
  ...
  return (
    <Suspense fallback={<Loading />}>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{contentBlock.title}&apos;s Content Block Products</h3>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{contentBlock.title}&apos;s Content Block Collections</h3>
