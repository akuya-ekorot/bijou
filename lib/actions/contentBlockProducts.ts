...
const revalidateContentBlockProducts = () => revalidatePath("/content-block-products");

export const createContentBlockProductAction = async (input: NewContentBlockProductParams) => {
  try {
...
export const updateContentBlockProductAction = async (input: UpdateContentBlockProductParams) => {
  try {
...
export const deleteContentBlockProductAction = async (input: ContentBlockProductId) => {
  try {
