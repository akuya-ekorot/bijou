...
const revalidateContentBlockCollections = () =>
  revalidatePath('/content-block-collections');

export const createContentBlockCollectionAction = async (
  input: NewContentBlockCollectionParams,
) => {
  try {
...
export const updateContentBlockCollectionAction = async (
  input: UpdateContentBlockCollectionParams,
) => {
  try {
...
export const deleteContentBlockCollectionAction = async (
  input: ContentBlockCollectionId,
) => {
  try {
