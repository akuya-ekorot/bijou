...
const revalidateCollectionProducts = () => revalidatePath("/collection-products");

export const createCollectionProductAction = async (input: NewCollectionProductParams) => {
  try {
...
export const updateCollectionProductAction = async (input: UpdateCollectionProductParams) => {
  try {
...
export const deleteCollectionProductAction = async (input: CollectionProductId) => {
  try {
